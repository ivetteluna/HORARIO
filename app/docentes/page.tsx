...
// ... (El resto del código de la página de docentes se mantiene igual hasta el formulario)
...
function DocenteForm({
  ...
  const agregarRestriccion = () => {
    if (nuevaRestriccion.dia && nuevaRestriccion.periodo && nuevaRestriccion.actividad) {
      ...
      setNuevaRestriccion({ dia: "", periodo: "", actividad: "" }) // Reset form
    } else {
      toast({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* ... (Se mantiene la sección de Información Personal y Profesional) ... */}
      ...
      <div className="space-y-4 rounded-lg border bg-gray-50 p-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          ...
          <div className="space-y-2 md:col-span-2">
            <Label>Actividad (Ej: Reunión, Cita Médica)</Label>
      ...
      {/* ... (Se mantiene la sección de Asignaciones por curso) ... */}
